...
`project/config/experiments/multivariate.yaml` (config files only, never hardcoded).
...
def load_config() -> dict:
    """Analysis policy from the project experiment config (never hardcoded)."""
    cfg_path = PATHS.experiment_configs / "multivariate.yaml"
