...
| STATE-20260901-029 | checkpoint | open | main agent | main agent | 2026-09-01 | euromonitor deliverable notebook | PVTI_lAHOAZFnCc4Bhhjqzg4_Cwg | synced | Deliverable entity_resolution.ipynb produces SKU_ID -> ITEM_ID (71,623 SKUs -> 11,223 ITEMs) via dedupe + brand x macro blocking + bi-encoder + barcode hard-links + volume-constrained soft links (brand+volume+0.85) + connected components. Fixed over-merging: macro-only blocking OOM'd at 87.8M edges; 0.55 soft link merged cross-category into 3,703 clusters. |
