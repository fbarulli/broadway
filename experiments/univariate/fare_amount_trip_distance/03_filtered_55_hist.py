"""03: histogram of metered fare_amount.

Loads the cleaned sample, keeps metered fares (fare_amount < $55), and plots a
...
def main() -> None:
    ...
    plot_histogram(metered, RESULTS / "03_filtered_55_hist.png")
    print(f"metered rows: {len(metered)}")
    print(f"wrote {RESULTS / '03_filtered_55_hist.png'}")
