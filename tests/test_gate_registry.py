...
# no rows; SURF appended range extended to 104…140 for the euromonitor
# experiment surfaces (surfaces-fix + _link/08_pipeline + 08_data_prep as
# GATE-SURF-140); INFRA appended range
# extended to 121…149 for the graphify surface-reconciliation gate
# (GATE-INFRA-149); future mints append ≥155 (HPO) / ≥141 (SURF) / ≥150 (INFRA).
BAND_RANGES = {
    "INGEST": [(1, 9)],
    "ETL": [(10, 19), (115, 117)],
    "FEAT": [(20, 29)],
