...
def test_flows_dispatch_per_mode() -> None:
    expected = {
        "taxi": ["discover", "etl", "contracts", "baseline", "features", "train", "evaluate"],
        "taxi_hypothesis": ["discover", "etl", "contracts", "baseline", "stats"],
        "taxi_causal": ["discover", "etl", "contracts", "baseline", "causal"],
    }
